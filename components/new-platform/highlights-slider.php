...
function render_hightlight_cards()
{
  ...
  foreach ($platform_cards as $card) {
    ...
    <div class="platform__highlight__card h-full lg:px-4 items-center">
      <div class=" platform__highlight__card__body shadow-xl relative flex flex-col items-center w-full bg-dark-blue-background px-3 py-10 rounded-xl h-full overflow-hidden">
