...
function render_hightlight_cards()
{
  ...
  foreach ($platform_cards as $card) {
    ...
    <div class="platform__highlight__card h-full lg:px-4 items-center">
      ...
      style="box-shadow: 0 0 20px -4px rgba(0,0,0,.75);
            -webkit-box-shadow: 0 0 20px -4px rgba(0,0,0,.75);
        ...
        <div class="w-full h-full z-20 flex flex-col items-center card__content__container">
          <p class="text-white font-bold text-xl lg:text-2xl text-center mb-2 lg:mb-8 title">' . $card['card_title'] . '</p>
