...
function render_insights_slider() {
  ...
  foreach ($arr as $slide) {
    echo '
      <div>
        <div class=" rounded-xl flex flex-col items-center bg-blue-300 p-2 mr-6 ">
          ...
          <p class="text-white text-base text-center">Ceritlytics History of Deep Learning Applications</p>
          <p class="text-white">
            Read Article
...
<section class="ai__insights w-full py-14">
  <div class="w-full flex flex-col items-center">
    <p class=" text-dark-blue-background text-4xl reveal-text font-bold">AI Insights by Certilytics</p>
