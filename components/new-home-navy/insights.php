...
function render_new_cards()
{
    ...
    foreach ($related_posts as $tmp_post_id) {
        ...
        echo '<div class="insights__card__text--navy md:h-64 lg:h-56 2xl:h-64 flex flex-col justify-between p-4 custom-shadow rounded-b-lg">';
        ...
        echo '<a href="' . get_permalink($tmp_post_id) . '" target="_blank" class=" text-dark-blue-background font-semibold cursor-pointer inline-flex items-center md:mb-2 lg:mb-0 underline underline-offset-1  hover:text-primary transition duration-300 ease-in text-xs md:text-sm 2xl:text-base">Read the Article
