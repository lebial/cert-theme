...
<section class="home__credibility__section w-full h-full">
    ...
    <div class="credibility__body w-11/12 md:w-9/12 lg:w-7/12 mx-auto pb-12 lg:pb-20 flex justify-center text-dark-blue-background">
        <p class=" text-dark-blue-background text-center" style="color: #000f3a;">
            <?php echo strip_tags(get_field('description')) ?>
        </p>
    </div>
