  ...
  foreach($card_data as $card) {
    ...
    echo '<div class="h-full" >';
      echo '<div class="rounded-md custom-shadow flex flex-col items-center my-4 mx-2.5 text-black p-8" style="height: 98%;">';
        ...
        // echo '<p class="w-full text-base px-1 mb-6 line-clamp-4 overflow-ellipsis ">'.$post->post_excerpt.'</p>';
...
<div class="w-full h-full py-16 mt-14">
  ...
  <div class="insights-carousel w-11/12 mx-auto my-4" data-aos="fade-up"> 
    <?php render_cards() ?>
  </div>
</div>