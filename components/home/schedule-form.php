<section class="w-screen relative flex flex-col xl:flex-row p-10 2xl:p-20" id="<?php the_field('schedule_demo_section_id')?>">
  ...
  <div style="z-index: -1; background-image: url(<?php the_field('schedule_bg_image')?>);" class="absolute top-0 left-0 block md:hidden h-full w-full bg-cover bg-no-repeat"></div>
