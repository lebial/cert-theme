...
require __DIR__ . '/provider_bars.php';
function render_slider_points()
{
    $animations = [
        ...
        'provider_bars_animation' => 'get_provider_bars',
    ];
...
<section
    ...
    <div class="w-full lg:w-6/12 flex flex-col justify-center items-center lg:pl-20 2xl:pl-40">
        <div class="w-fit">
            ...
            <h2
                class="text-primary uppercase tracking-wide text-base mt-9 lg:mt-0 block lg:hidden text-center mb-2 max-w-[30ch] px-4">
