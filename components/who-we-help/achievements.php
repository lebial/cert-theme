...
function render_nav_links()
{
    ...
    foreach ($options as $option) {
        echo '
        <div class="flex px-6">
            <a class="lg:text-lg 2xl:text-xl text-dark-blue-background group transition-all duration-300 hover:text-primary" href="' . $option['url'] . '">
                ' . $option['text'] . '
    ...
    foreach ($achievements as $idx => $achievement) {
        ...
        echo '
            <div class="achievement__body flex flex-col items-center mx-14">
                <p class="lg:text-2xl 2xl:text-4xl text-dark-blue-background mb-4 font-bold" data-aos="fade-up" data-aos-delay="' . $delay . '">' . $achievement['title'] . '</p>
                <p class=" lg:text-xl 2xl:text-2xl text-dark-blue-background text-center">' . $achievement['body'] . '</p>
            </div>
        ';
    }
}
...
<section class="achievements-section">
    ...
    <div class="flex justify-center py-20">
        <h3 class="text-4xl text-center text-dark-blue-background reveal-text"><?php the_field('achievements_title') ?>
        </h3>
    </div>
