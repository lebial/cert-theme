...
function render_buttons($opts)
{
    foreach ($opts as $option) {
        ...
        echo '
            <button type="button" name="' . $button['button_text'] . '" class="our__approach__button text-white text-center lg:text-left text-lg lg:text-2xl border-b border-gray-400 border-solid py-4 lg:py-6 first-of-type:pt-0 lg:pr-10 opacity-50 transition-all duration-300 hover:opacity-100">
            ' . $button['button_text'] . '
