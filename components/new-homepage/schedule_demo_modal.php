...
?>
<div
  class="schedule__demo__modal w-full flex h-screen fixed top-0 left-0 bg-black bg-opacity-60 justify-center items-center z-[999]"
  ...
  <div class="schedule__demo__modal__body w-11/12 md:w-8/12 relative h-fit min-h[550px] flex flex-col lg:flex-row"
    style="background: linear-gradient(90deg, rgba(24,15,54,1) 0%, rgba(24,15,54,1) 50%, rgba(255,255,255,1) 50%);">
    <button type="button"
    ...
    <div class="w-1/2 h-full bg-dark-blue-background px-10 pt-10 pb-6 hidden lg:block ">
      <p class="text-white text-base 3xl:text-xl font-bold mb-4"> See how we<br class="block xl:hidden"> can help you
        achieve <br class="block xl:hidden"> your <br class="hidden xl:block"> total cost of <br
          class="block xl:hidden"> care goals.</p>
      ...
      <div class="contact__image__container flex justify-center">
        <img class=" max-w-[200px] xl:max-w-xs" src="<?php the_field('contact_us_modal_laptop_image', 'options') ?>"
          alt="contact us report image">
      </div>
      ...
      <div class="points__container mt-5 mb-4">
        ...
        <div class="flex mb-2 relative">
          <?php render_arrow_svg() ?>
          <p class="text-white text-xs 3xl:text-base pl-4">Optimize programs and strategies to lower costs and improve
            outcomes</p>
        </div>
        <div class="flex mb-2 relative">
          <?php render_arrow_svg() ?>
    ...
    <div class="w-full lg:w-1/2 h-full bg-white">
      <div class="schedule__demo__form__container px-5 lg:px-10 pt-10 pb-6">
        ...
        <div class="mb-5 demo__form__message">
          <p class="text-center text-sm 2xl:text-base">Fill out the form below - and choose a meeting<br> that works for
            you.</p>
        </div>
