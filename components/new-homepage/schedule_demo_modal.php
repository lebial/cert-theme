<div class="schedule__demo__modal w-full flex h-screen fixed top-0 left-0 bg-black bg-opacity-60 justify-center items-center z-[999]" style="display: none; opacity: 0;">
  <div class="schedule__demo__modal__body w-11/12 md:w-1/2 relative h-fit bg-dark-blue-background 3xl:bg-white flex flex-col lg:flex-row">
    ...
    <div class="w-1/2 h-full bg-dark-blue-background px-10 py-6 hidden lg:block ">
    ...
    <div class="w-full lg:w-1/2 h-full bg-white">
      <div class="schedule__demo__form__container px-5 lg:px-10 py-6">
