<section class="platform__contact__us lg:min-h-[50vh]" id="<?php the_field('platform_contact_us_section_id')?>">
  <div class="contact__us__image__container w-full lg:min-h-[50vh] relative text-center flex justify-end items-center">
    ...
    <div class="action__quote__container w-full lg:w-6/12" data-aos="fade-up">
      <div class="w-full flex flex-col items-center px-8 md:px-32 lg:px-0 lg:pr-20 pt-16 lg:pt-0">
        <h3 class="action__quote__container__text text-3xl 2xl:text-5xl text-white font-bold text-center mb-0" ><?php the_field('contact_us_title') ?></h3>
