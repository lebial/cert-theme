<?php
 ...
 ?>
<!-- <section class="validation__security min-h-[80vh] md:min-h-[53vh] lg:min-h-[65vh] 2xl:min-h-[70vh] relative py-8 flex flex-col bg-dark-blue-background" id="<?php the_field('validation_section_id')?>"> -->
