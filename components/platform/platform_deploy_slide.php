...
?>
<section class="platform__deploy__options bg-gray-100 flex flex-col lg:flex-row">
  ...
  <div class=" px-8 py-12 pt-0 lg:pt-16 w-full lg:w-1/2">
    <div class="sticky top-28">
      <img
        class="style-svg platform__deployment__graphic hidden lg:block"
        src="<?php the_field('desktop_graphic')?>"
        alt="Platform Deployment Options"
      >
      <img
        class="style-svg w-full block lg:hidden"
