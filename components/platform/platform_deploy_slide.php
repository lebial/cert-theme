...
<section class="platform__deploy__options bg-dark-blue-background">
  <div class="deploy__options__container px-12 py-10 w-full">
    <p class="text-4xl text-center text-secondary">Platform Deployment Options</p>
    <div class="deploy__icon__header w-full flex uppercase text-center mt-10 ">

      <div class="w-1/2 flex-col flex items-center relative">
        <p class="font-bold text-secondary"><?php echo $customer_env['text'] ?></p>
        <img class="max-w-none w-64 absolute" style="top: 15%;" src="<?php echo $customer_env['icon'] ?>" alt="">
      </div>

      <div class="w-1/2 flex-col flex items-center relative">
        <p class="font-bold text-primary"><?php echo $certilytics_env['text'] ?></p>
    ...
    <div class="deploy__data__header w-full pt-10 pb-2">
      <p class="mx-auto w-1/2 text-center text-white font-bold text-2xl">Software as a Service (SaaS)</p>
    </div>
    <div class="deploy__data__content w-full flex">
      <div class="content__body w-1/2 flex flex-col items-center">
    ...
    <div class="deploy__data__header w-full pb-2">
      <p class="mx-auto w-1/2 text-center text-white font-bold text-2xl">Platform as a Service (PaaS)</p>
    </div>
    <div class="deploy__data__content w-full flex">
      <div class="content__body w-1/2 flex flex-col items-center">
    ...
    <div class="deploy__data__header w-full pb-2">
      <p class="mx-auto w-1/2 text-center text-white font-bold text-2xl">Self Hosted</p>
    </div>
    <div class="deploy__data__content w-full flex">
      <div class="content__body w-1/2 flex flex-col items-center">
        <div class="w-full h-14 bg-secondary text-white">
