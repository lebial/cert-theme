...
<section class="solutions-parallax block lg:pb-60 lg:block solutions__section w-screen min-h-screen bg-cover bg-dark-blue-background mt-11 " style="background-image: url(<?php the_field('proven_solution_background') ?>); width: 100vw" id="<?php the_field('platforms_section_id') ?>">
  <div class="solutions__section__container" data-sticky="from: -65px, duration: 720vh">
    ...
    <div class="w-screen h-screen sticky">
      ...
      <div class="w-full slides__body relative pl-[7%]">
        ...
        <!-- slide 0 -->
        <div class="slide__container__hook px-[7%] xl:px-0 overflow-y-scroll h-[75vh] xl:h-auto flex flex-col lg:flex-row items-center lg:items-start absolute top-0 left-0 w-full pt-4 z-[-1]" data-animation="opacity: {0: 1, 20vh: 1, 130vh: 0}, transform: {0: translate(0,0), 20vh: translate(0,0), 130vh: translate(0, -20%)}" data-classes="-90vh: {add: numberAnimationHook}" data-aos="fade-up">
          ...
          <div class="w-full xl:w-1/2 flex flex-col items-end">
            <div class="w-full xl:w-10/12">
              ...
              <p class="text-white text-lg">
                Use Brainstorm&reg; AI, Certilytics' propriety deep learning and generative AI technology built for healthcare,
                to uncover predictive insights. Answer your most pressing questions with a turnkey data science solution to train, validate,
        ...
        <!-- slide 1 -->
        <div class="slide__container__hook px-[7%] xl:px-0 overflow-y-scroll h-[75vh] xl:h-auto flex flex-col lg:flex-row items-center lg:items-start absolute top-0 left-0 w-full pt-4 z-[-1] invisible" data-animation="opacity: {130vh: 0.4, 150vh: 1, 190vh: 1, 280vh: 0}, transform: {0: translate(0,0), 190vh: translate(0, 0), 280vh: translate(0, -20%)}" data-classes="130vh: {remove: invisible, add: numberAnimationHook}" data-aos="fade-up">

          <div class="w-full xl:w-1/2 flex flex-col items-end">
            <div class="w-full xl:w-10/12">
              <p class="text-white text-3xl xl:text-[55px] mt-4 leading-relaxed xl:leading-tight">Data Processing At Scale</p>
              <p class="text-white text-lg">
                Our AI-centered platform was built with the latest open-source technologies to process big data at scale for some
        ...
        <!-- slide 2 -->
        <div class="slide__container__hook px-[7%] xl:px-0 overflow-y-scroll h-[75vh] xl:h-auto flex flex-col lg:flex-row items-center lg:items-start absolute top-0 left-0 w-full pt-6 invisible z-[-1]" data-animation="opacity: {280vh: 0.4, 290vh: 1, 330vh: 1, 430vh: 0}, transform: {0: translate(0,0), 330vh: translate(0, 0), 430vh: translate(0, -20%)}" data-classes="280vh: {remove: invisible, add: numberAnimationHook}">
        ...
        <!-- slide 3 -->
        <div class="slide__container__hook px-[7%] xl:px-0 overflow-y-scroll h-[75vh] xl:h-auto flex flex-col lg:flex-row items-center lg:items-start absolute top-0 left-0 w-full pt-4 invisible z-[-1]" data-animation="opacity: {430vh: 0.4, 450vh: 1, 490vh: 1, 580vh: 0}, transform: {0: translate(0,0), 490vh: translate(0, 0), 580vh: translate(0, -20%)}" data-classes="430vh: {remove: invisible, add: numberAnimationHook}">
          <div class="w-full xl:w-1/2 flex flex-col items-end" data-aos="fade-up">
            <div class="w-full xl:w-10/12 ">
        ...
        <!-- slide 4 -->
        <div class="slide__container__hook px-[7%] xl:px-0 overflow-y-scroll h-[75vh] xl:h-auto flex flex-col lg:flex-row items-center lg:items-start absolute top-0 left-0 w-full pt-4 invisible z-[-1]" data-animation="opacity: {580vh: 0.4, 630vh: 1}" data-classes="580vh: {remove: invisible, add: numberAnimationHook}" data-reverse="true">
          <div class="w-full xl:w-1/2 flex flex-col items-end" data-aos="fade-up">
            <div class="w-full xl:w-10/12 ">
              <p class="text-white text-3xl xl:text-[55px] mt-4 leading-relaxed xl:leading-tight">Faster Deployment</p>
              <p class="text-white text-lg">
                With the power of AI, accelerate your access to market leading predictive analytics through our proven,
              ...
              <div data-proven-anim="proven-anim" class="proven-solution-graph mx-auto mt-4 hidden lg:block" style="width: 3.2%;" data-classes="420vh: { add: exec-animate }">
          ...
          <div class="w-1/2 flex flex-col items-center pt-8">
            ...
            <div data-proven-anim="proven-anim" class="proven-solution-graph mx-auto mt-4 block lg:hidden" style="width: 6%;" data-classes="420vh: { add: exec-animate }">
              <svg class="proven-solution-graph__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35.08 359.89">
                <g>
                  <polyline data-aos="proven-line" data-aos-duration="2500" data-aos-delay="500" points="14.86 13.23 14.86 18.21 14.86 30.63 14.86 167.49 5.66 179.94 5.66 292.31 14.86 303.5 14.86 336.88" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="1.24" />
                  <circle class="proven-dot-red" data-aos="proven-dot" data-aos-duration="500" data-aos-delay="900" cx="14.86" cy="347.79" r="4.32" fill="#f5695c" />
