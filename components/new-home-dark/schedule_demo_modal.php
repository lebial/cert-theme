<div class="schedule__demo__modal w-full flex h-screen fixed top-0 left-0 bg-black bg-opacity-60 justify-center items-center z-[999]" style="display: none; opacity: 0;">
  <div class="schedule__demo__modal__body w-11/12 md:w-1/2 relative h-fit bg-white flex flex-col lg:flex-row">
    ...
    <div class="w-1/2 h-full bg-dark-blue-background px-10 py-10 hidden lg:block ">
      ...
      <div class="points__container mt-5 mb-4">
        <div class="flex mb-2">
          ...
          <p class="text-white text-xs 2xl:text-base">Unify and add power to their data</p>
        </div>
        <div class="flex mb-2">
          <svg height="20" id="triangle-right" viewBox="0 0 32 32" width="20" class="fill-primary mr-1" xmlns="http://www.w3.org/2000/svg">
            <path d="M8 4 V28 L26 16 z" />
          </svg>
          <p class="text-white text-xs 2xl:text-sm">Predict emerging clinical and <br> financial risk</p>
        </div>
        <div class="flex mb-2">
          <svg height="20" id="triangle-right" viewBox="0 0 32 32" width="20" class="fill-primary mr-1" xmlns="http://www.w3.org/2000/svg">
            <path d="M8 4 V28 L26 16 z" />
          </svg>
          <p class="text-white text-xs 2xl:text-sm">Optimize programs and <br> strategies to lower coest and <br> improve outcomes</p>
        </div>
        <div class="flex mb-2">
          <svg height="20" id="triangle-right" viewBox="0 0 32 32" width="20" class="fill-primary mr-1" xmlns="http://www.w3.org/2000/svg">
            <path d="M8 4 V28 L26 16 z" />
          </svg>
          <p class="text-white text-xs 2xl:text-sm">Measure results and <br> demonstrate value</p>
        </div>
      </div>
    </div>
    <div class="w-full lg:w-1/2 h-full">
      <div class="schedule__demo__form__container px-5 lg:px-10 pt-10">
