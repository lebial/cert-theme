...
function render_new_cards()
{
    ...
    foreach ($related_posts as $tmp_post_id) {
        ...
        echo '<div class="insights__card__text--dark md:h-64 lg:h-56 2xl:h-64 flex flex-col justify-between p-4 custom-shadow rounded-b-lg">';
        echo '<div class="line-clamp overflow-hidden">';
        echo '<h3 class="text-base md:text-xl 2xl:text-xl lg:leading-5 2xl:leading-6 font-semibold mb-3 mt-2 text-black-background">' . get_the_title($tmp_post_id) . '</h3>';
        ...
        echo '<a href="' . get_permalink($tmp_post_id) . '" target="_blank" class="text-black-background font-semibold cursor-pointer inline-flex items-center md:mb-2 lg:mb-0 underline underline-offset-1  hover:text-primary transition duration-300 ease-in text-xs md:text-sm 2xl:text-base">Read the Article
...
<section class="home__insights__section w-full h-full flex items-center">
    <div class="container px-5 pb-20 lg:pb-28 2xl:pb-32 pt-16 mx-auto">
        <div class="text-center mb-4 md:mb-8 lg:mb-14">
            <h3 class="hidden lg:inline reveal-text text font-semibold text-2xl lg:text-4xl text-center text-black-background">Certilytics News & Expert Insights</h5>
                <h3 class="lg:hidden reveal-text text font-semibold text-2xl md:text-3xl lg:text-4xl text-center text-black-background">Certilytics News & <br> Expert Insights</h5>
        </div>
        ...
        <div class="lg:hidden w-full md:w-6/12 relative mx-auto">
            <div class="home__insights__slider mt-8 lg:mt-16 relative z-30">
                <?php render_new_cards() ?>
            </div>
            <div class="home__insights__slider__arrows w-[100vw] md:w-[65vw] absolute flex justify-between top-1/2 left-1/2 z-20" style="transform: translate(-50%, -50%)">
