...
function render_contact_details()
{
  ...
  foreach ($items as $item) {
    echo '<div class="contact__info__details pb-8 lg:pb-16">
            <div class="">
