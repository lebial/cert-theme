<section class="schedule__demo__section bg-indigo-50 pt-16 px-10 lg:px-0">
    <p class="text-2xl lg:text-4xl text-dark-blue-background font-bold text-center mx-auto reveal-text">
    ...
    <div class="bg-white px-10 max-w-xl mx-auto pt-4 rounded-2xl mt-10 lg:mt-0 shadow-xl relative lg:top-[90px]">
