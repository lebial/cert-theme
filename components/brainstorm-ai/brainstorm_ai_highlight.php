...
function render_highlight_cards() {
  ...
  foreach ($brainstorm_cards as $card ) {
    ...
    <div class="brainstorm__highlight__card flex-1 px-8">
      ...
      <p class="font-bold mb-2 text-2xl">'.$card['title'].'</p>
      <p class="text-xl">'.$card['body'].'</p>
    </div>
    ';
  }
}
...
<section class="brainstorm__ai__highlight w-full py-32 ">
  <p class=" text-dark-blue-background text-3xl xl:text-4xl mx-auto max-w-none text-center font-bold ">How Our Brainstorm AI<span class=" align-super !text-xl">®</span> is Different</p>
