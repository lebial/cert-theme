...
<section id="<?php the_field('video_section_id')?>" class="trusted__partner__section w-full flex flex-col lg:items-center lg:flex-row py-14 lg:py-32">
  ...
  <div class="w-full lg:w-1/2 flex justify-center lg:justify-start mb-8">
    <div class="mb-0 lg:mb-4 w-full px-4 lg:pl-12 mr-0 lg:mr-12">
      ...
      <h2 class="hidden lg:block font-normal text-2xl xl:text-4xl text-dark-blue-background mx-auto lg:mx-0 text-center lg:text-left reveal-text" data-reveal-direction="left">
        <?php echo $quote['title'] ?>
      </h2>
      <h2 class="block lg:hidden font-normal text-2xl xl:text-4xl text-dark-blue-background mx-auto lg:mx-0 text-center lg:text-left ">
        <?php echo $quote['title'] ?>
      </h2>
