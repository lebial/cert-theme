<?php if (have_posts()):
  while (have_posts()):
    ...
    $custom_content .= '...';
    ?>
    <div class="ai_insight_card rounded-lg mb-4 p-4 flex flex-col transition-all duration-300 hover:scale-105 ">
      ...
      <div class="ai_card_body flex-1 flex flex-col">
        ...
        <div class="flex-1 flex items-end">
          <a href="<?php echo get_the_permalink() ?>"
            class="py-1 px-2 border border-solid rounded-3xl border-primary text-primary tracking-tight
