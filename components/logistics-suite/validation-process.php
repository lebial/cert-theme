...
function render_data_points() {
  ...
  foreach ($cards as $idx => $card) {
    ...
    echo '
      <div class="logistics__point__card text-center lg:text-left flex items-center flex-col max-w-[350px] h-fit opacity-100 z-20 group flex-1 hover:cursor-pointer relative '.$active.'" name="'.$position.'">
...
<section class="data-ingestion__validation__process w-full h-full bg-slate-100 py-16">
  ...
  <div class="w-8/12 lg:w-10/12 mx-auto relative lg:mt-24 flex flex-col lg:flex-row justify-between">
    ...
    <div id="dataSecurity" class="navigation__container hidden mx-auto lg:flex justify-center">
