<section
    ...
    <div class="">
        <h2 class="text-primary uppercase text-xl lg:text-2xl xl:text-3xl text-center tracking-wide">
        ...
        <p class="text-white text-center"><?php the_field('hero_description') ?></p>
    </div>
</section>