<section
    class="solutions__page__hero w-full bg-dark-blue-background min-w-full relative h-[60vh] lg:h-[90vh] bg-cover flex justify-center items-center"
    ...
    <div>
        ...
        <h1 class="text-white  text-2xl lg:text-4xl xl:text-6xl text-center tracking-normal"><?php the_field('hero_title') ?></h1>
        <div class="divider bg-primary h-px w-80 mx-auto my-10"></div>
        <div class="w-9/12 mx-auto lg:w-full">
