<div class="w-screen h-screen fixed flex justify-center items-center bg-white z-[999] top-0" id="page-loader">
    ...
    <div class="w-32">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px" y="0px" viewBox="0 0 511.8 508.3" style="enable-background:new 0 0 511.8 508.3;"
            xml:space="preserve">
            <style type="text/css">
                .cert-st8 {
                    fill: #1F5EDB;
            ...
            <g>
                ...
                <g>
                    <polygon class="cert-st20"
                        points="228.6,210.6 305.7,256.3 311.2,247 239.1,204.3 311.2,161 305.7,151.7 225.8,199.7 145.9,247.6 
