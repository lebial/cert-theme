<?php function renderHeaderQuotes()
{
  ...
  foreach ($header_quotes as $quote) {
    echo '<div class="carousel__quote text-white font-bold text-lg lg:text-xl text-center lg:text-left leain leading-tight">' . $quote['copy'] . '</div>';
  };
}
?>
...
<section class="h-[75vh] w-full bg-dark-blue-background bg-cover">
  ...
  <div class="about__us__hero__dots carousel-dots text-center mt-[-8rem] md:mt-[-21rem] lg:mt-[-4rem]">
  </div>
</section>