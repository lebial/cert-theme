...
<section class="new_approach_to_value w-full flex mt-10">
  <div class="w-1/2 bg-dark-blue-background pl-24 py-14">
    <p class="text-white text-4xl">A New Approach to Value-Based <br> Decision-Making:</p>
    <div class="points__list pt-14">
      <?php render_points(); ?>
    </div>
  </div>
  <div class="w-1/2">
    <img class="w-full" src="<?php the_field('value_points_background') ?>" alt="value points">
  </div>
</section>