    ...
    <div class="flex flex-col lg:items-center lg:flex-row py-12 lg:py-20 w-10/12 mx-auto max-w-screen-2xl">
        <div name="desktop_main_video" class="h-full hidden w-1/2 lg:flex justify-center ">
            <div class="w-full lg:w-[72%] h-fit flex flex-col lg:justify-center relative">
                ...
                <video class="home__secondary__video object-cover w-full h-full rounded-xl shadow-lg"
                    poster="<?php the_field('about_us_main_video_thumbnail') ?>" name="about us">
        ...
        <div class="w-full lg:w-1/2 flex justify-center lg:justify-start">
            <div class="w-full lg:pl-12 mr-0 lg:mr-12">
                ...
                <h3 class="font-bold text-2xl xl:text-4xl text-dark-blue-background mx-auto lg:mx-0 text-center lg:text-left reveal-text hidden lg:block"
                    data-reveal-direction="left">
                    <?php echo $quote['title'] ?>
                </h3>
                <h3
                    class="font-bold text-2xl xl:text-4xl text-dark-blue-background mx-auto lg:mx-0 text-center lg:text-left block reveal-text lg:hidden">
                    <?php echo $quote['title'] ?>
                </h3>
                ...
                <div name="mobile_main_video"
                    ...
                    <div class="w-full lg:w-[72%] h-fit flex flex-col lg:justify-center ml-0 lg:ml-12 relative">
                        ...
                        <video class="home__secondary__video object-cover w-full h-full rounded-xl shadow-lg"
                            poster="<?php the_field('about_us_main_video_thumbnail') ?>">
                            <source src="<?php the_field('about_us_main_video_url') ?>" type="video/mp4">
                        </video>
                    </div>
                </div>
                <p
                    class="text-dark-blue-background max-w-xl text-center lg:text-left mx-auto lg:mx-0 text-lg mb-8 font-light">
