    ...
    <div name="desktop_innovation_video" class="h-full w-8/12 lg:w-1/2 lg:flex justify-center pt-12 ">
      <div class="w-full lg:w-[72%] h-fit flex flex-col lg:justify-center relative">
        <div id="videoContainer" class="w-full h-full absolute flex justify-center items-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-xl z-20" style="box-shadow: 8px 8px 10px 0 rgba(0, 0, 0, 0.25);">
          ...
          <div class="thumbnail__text w-5/12 absolute top-0 mt-8 bg-dark-blue-background bg-opacity-80 px-4 py-8 rounded-xl">
            <p class="w-full inset-0 flex items-center justify-center !mb-4 text-white text-sm rounded-xl pointer-events-none leading-[1.1rem] font-medium">
              <?php the_field('quote') ?>
            </p>
            <div class="red__divider w-2/12 mx-auto lg:mx-0 mb-2 lg:mt-0 border-[0.1px] border-primary border-solid"></div>
            <p class="thumbnail__text--author text-sm text-white leading-3">
