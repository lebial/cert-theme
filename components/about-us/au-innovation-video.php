<section class="relative w-full h-[47vh] lg:h-[73vh] bg-cover bg-no-repeat bg-center bg-dark-blue-background"
  ...
  <div class="flex justify-center flex-col items-center h-full py-16 mx-auto max-w-screen-5xl">
    ...
    <div name="desktop_innovation_video"
      class="absolute inset-x-0 bottom-12 lg:bottom-24 -translate-y-1/4 w-11/12 lg:w-7/12 mx-auto flex justify-center items-center max-w-screen-2xl z-10">
      <div class="absolute w-11/12 lg:w-[72%] 4xl:w-[57%] flex flex-col lg:justify-center">
        <div id="videoContainer"
          class="w-full h-full absolute flex justify-center items-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-xl z-20"
          style="box-shadow: 8px 8px 10px 0 rgba(0, 0, 0, 0.25);">
        ...
        <video id="healthcareInnovation"
          class="home__secondary__video relative object-cover w-full h-fit rounded-xl shadow-lg"
          poster="<?php the_field('innovation_main_video_thumbnail') ?>" name="about us healthcare innovation">
        ...
        <div
          class="thumbnail__text flex flex-col justify-center md:block w-5/12 md:w-4/12 h-full md:h-auto absolute top-0 md:mt-6 bg-dark-blue-background bg-opacity-80 px-4 py-4 lg:px-[1.3rem] lg:py-6 rounded-xl">
          <p
            class="hidden w-full inset-0 md:flex items-center justify-center mb-2 text-white text-[11px] md:text-xs 2xl:text-base rounded-xl pointer-events-none leading-4 md:leading-[1.1rem] font-normal">
            <?php the_field('quote') ?>
          </p>
          <!-- mobile quote-->
          <p
            class="md:hidden w-full inset-0 flex items-center justify-center mb-2 text-white text-[11px] md:text-xs 2xl:text-base rounded-xl pointer-events-none leading-4 md:leading-[1.1rem] font-normal">
