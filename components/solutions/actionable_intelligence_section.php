...
<section class="actionable_intelligence w-full flex flex-col justify-center bg-dark-blue-background py-24">
    ...
    <h2 class="text-white text-3xl lg:text-4xl text-center relative z-20 mb-0 lg:-mb-20 px-3">
        <?php the_field('actionable_intelligence_section_title') ?></h2>
    <img src="<?php the_field('actionable_intelligence_section_image_desktop') ?>" class="hidden md:block relative z-10 " alt="actionable intelligence desktop">
    <img src="<?php the_field('actionable_intelligence_section_image_mobile') ?>" class="block md:hidden relative z-10" alt="actionable intelligence mobile">
