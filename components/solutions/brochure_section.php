    ...
    <div class="graphic__row w-10/12 mt-16 lg:mt-24">
        <div class="graphic__data flex flex-col lg:flex-row">
            <div class="data w-full lg:w-6/12 flex justify-center lg:justify-end">
                <div class="max-w-lg">
                    <h2 class="text-white text-2xl lg:text-4xl font-bold text-center lg:text-left"
                        style="line-height: 1.3;"><?php the_field('brochure_section_title') ?></h2>
    ...
    <div class="graphic__row w-10/12 flex flex-col items-center lg:flex-row mt-10">
        <div class="graphic__content w-full lg:w-1/2 flex justify-end">
            <div class="lg:max-w-lg relative  w-full flex justify-center min-h-[1px] lg:justify-start ">
                ...
                <div><img class="relative left-0 top-0 lg:absolute lg:top-[-41px] lg:left-1/2 lg:-translate-x-1/2 style-svg w-[300px]" src="<?php the_field('impact_evaluator_logo') ?>"
                        alt="impact evaluator logo"></div>
            </div>
        </div>
        <div
            class="graphic__content brochure__points w-full lg:w-1/2 mt-10 lg:mt-0 flex justify-center lg:justify-start">
