  ...
  <div class="relative w-full mt-16">
    <div class="block md:hidden solutions__video__container w-full">
      <div class="solutions__video__body relative mb-10">
        ...
        <div class="solutions__Mobile__video__overlay absolute shadow-xl flex items-end w-[101%] h-[105%] left-1/2 -translate-x-1/2 top-0 p-1 lg:p-6 bg-cover" style="background: linear-gradient(rgba(87, 134, 228, 0.7),rgba(87, 134, 228, 0.7)), url(<?php the_field('video_thumbnail')?>); background-size: cover;">
          <div class="overlay__content h-full">
            ...
            <button id="solutionsMobileVideoButton" class="hero__button-modal z-10 bottom-0 relative" type="button">
