<section class="case__study w-full flex flex-col items-center py-20">
    <div class="content__container w-10/12 lg:w-7/12 flex flex-col md:flex-row">
        <div class="case__study__description w-full md:w-1/2 lg:w-7/12">
            ...
            <p class="text-sm">
                Certilytics' predictive insights support health & wellness programs for dozens of large,
                self-funded employers. A retrospective analysis shows these programs save participating
                employers an average of over $200 PMPY while improving employee health.
            </p>
