...
<section class="solutions__header w-full bg-dark-blue-background flex justify-center items-center bg-cover" style="background-image:url(<?php the_field('header_background')?>); background-size: cover; margin-top: 0;">
  <!-- <div class="w-full md:w-9/12 lg:w-1/2 px-4 lg:px-0 text-center my-12 lg:my-32 relative"> -->
  <div class="w-full px-4 lg:px-0 text-center my-12 lg:my-32 relative">
    ...
    <!-- <div class="hidden md:block solutions__video__container absolute w-11/12 md:w-[75%] 2xl:w-[65%] left-1/2 -translate-x-1/2 top-[110%]"> -->
    <!-- <div class="hidden md:block solutions__video__container absolute w-11/12 md:w-[35%] max-w-xl left-1/2 -translate-x-1/2 top-[110%]">
      <div class="solutions__video__body relative">
        ...
        <div class="solutions__Desktop__video__overlay shadow-lg absolute flex items-center w-[101%] h-full left-1/2 -translate-x-1/2 top-0 p-1  bg-cover " style="background: linear-gradient(rgba(76, 120, 207, 0.7),rgba(76, 120, 207, 0.7)), url(<?php the_field('video_thumbnail')?>); background-size: cover;">
          <div class="overlay__content w-full">
            <div class="w-full">
              <p class="text-white text-base xl:text-xl 2xl:text-2xl text-left pl-4 lg:pl-8" style="line-height: 2;"><?php the_field('thumbnail_description')?></p>
            </div>
