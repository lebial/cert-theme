  ...
  <div class="w-full md:w-8/12 lg:w-1/2 px-4 lg:px-0 text-center my-12 lg:my-32 relative">
    ...
    <div class="solutions__video__container absolute w-11/12 md:w-[60%] left-1/2 -translate-x-1/2 top-[110%]">
      <div class="solutions__video__body relative">
        ...
        <div class="video__overlay absolute flex items-end w-[101%] h-full left-1/2 -translate-x-1/2 top-0 p-1 lg:p-6 bg-cover" style="background: linear-gradient(rgba(87, 134, 228, 0.7),rgba(87, 134, 228, 0.7)), url(<?php the_field('video_thumbnail')?>); background-size: cover;">
