...
<section class="intuitive__insights health__plans__insights w-full py-16 lg:py-24">
    ...
    <div class="insights__container content__box w-11/12 max-w-fit mx-auto bg-[#b2b2b2] bg-opacity-10 mt-4 lg:mt-20 p-8 lg:p-12 shadow-lg flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-1/2 lg:pl-10 items-center mt-6 lg:mt-0">
            <div class="content__description max-w-sm flex flex-col justify-center">
                ...
                <a class="download__brochure__link bg-primary mt-4 mx-auto lg:mx-0 w-fit rounded-lg px-6 py-2 text-white text-sm" href="#">Download Brochure</a>
            </div>
        </div>
