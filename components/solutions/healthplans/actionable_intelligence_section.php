...
<section class="actionable_intelligence w-full flex flex-col justify-center bg-dark-blue-background py-24">
    ...
    <img src="<?php the_field('actionable_intelligence_section_image_desktop') ?>" class="hidden md:block relative z-10" alt="actionable intelligence image desktop">
    <img src="<?php the_field('actionable_intelligence_section_image_mobile') ?>" class="block md:hidden relative z-10" alt="actionable intelligence image mobile">
