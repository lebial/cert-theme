...
<section class="solutions__header w-full bg-dark-blue-background bg-center md:bg-left flex justify-center items-center bg-cover min-h-[40vh] lg:min-h-[45vh]"
    style="background-image:url(<?php the_field('header_background') ?>); background-size: cover; margin-top: 0;">
