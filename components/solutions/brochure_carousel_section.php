...
function render_brochure_slides()
{
    ...
    foreach ($brochure_slides as $slide) {
        ...
        echo '<img class="data__image__mobile pt-8 lg:pt-0 lg:hidden w-full lg:w-6/12" src="' . $slide['mobile_image'] . '" alt="slide image mobile" />';
        ...
        echo '<img class="data__image hidden lg:visible md:max-w-[70%] md:max-h-[90%] lg:max-w-[80%] md:flex md:justify-center md:items-center" src="' . $slide['desktop_image'] . '" alt="slide image desktop" />';
