...
<section class="home__credibility__section w-full h-full">
    <div class=" w-10/12 mx-auto max-w-4xl lg:pt-12 mb-0 lg:mb-4 flex justify-center">
        <h2 class="font-normal text-3xl lg:text-5xl text-center text-white">
    ...
    <div class="credibility__body--dark-full w-11/12 md:w-9/12 lg:w-7/12 mx-auto pb-12 lg:pb-20 flex justify-center">
