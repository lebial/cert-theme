    ...
    <header class="z-50 sticky">
        ...
        <div class="flex-1 flex justify-end">
            ...
            <button class="new__burger__menu text-white relative w-10" type="button">
                <svg class="w-7 absolute top-2 left-0" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px"
                    viewBox="0 0 700 700" style="enable-background:new 0 0 700 700;" xml:space="preserve">
                    <path class=" fill-white"
        ...
        <div
            class=" main__menu__sidebar w-[70vw] min-h-screen absolute top-0 -right-full flex flex-col items-center bg-white">
            <div class=" w-9/12">
